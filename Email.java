...
public class Email{
	...
	public static void main(String[] args){
		String clave = "grhozilznfnynzmq";
		Email e = new Email("proyectodatos5@gmail.com", clave, "cif14150@uvg.edu.gt", "prueba", "YA FUNCIONO ESTA PORQUERIA");
		if(e.sendMail()){
